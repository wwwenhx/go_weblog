...
var file_userService_proto_rawDesc = []byte{
	...
	0x64, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x04, 0x63, 0x6f, 0x64, 0x65, 0x32, 0xb5,
	...
	0x73, 0x65, 0x72, 0x52, 0x65, 0x73, 0x42, 0x06, 0x5a, 0x04, 0x2e, 0x2f, 0x70, 0x62, 0x62, 0x06,
...
var file_userService_proto_depIdxs = []int32{
	...
	2, // 7: User.UserLogin:output_type -> UserRes
	2, // 8: User.UserRegister:output_type -> UserRes
	2, // 9: User.GetAllUser:output_type -> UserRes
	2, // 10: User.ChangePassword:output_type -> UserRes
	2, // 11: User.ChangeName:output_type -> UserRes
